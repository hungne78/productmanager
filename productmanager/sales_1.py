...
class RightFourBoxWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.tbl_box1.horizontalHeader().setVisible(False)  # 가로 헤더 숨기기
        self.tbl_box1.verticalHeader().setVisible(False)    # 세로 헤더 숨기기  
        ...
        self.tbl_box2.horizontalHeader().setVisible(False)  # 가로 헤더 숨기기
        self.tbl_box2.verticalHeader().setVisible(False)    # 세로 헤더 숨기기  
        ...
        self.tbl_box3_top.horizontalHeader().setVisible(False)  # 가로 헤더 숨기기
        self.tbl_box3_top.verticalHeader().setVisible(False)    # 세로 헤더 숨기기  
        ...
        self.tbl_box3_bottom.horizontalHeader().setVisible(False)  # 가로 헤더 숨기기
        self.tbl_box3_bottom.verticalHeader().setVisible(False)    # 세로 헤더 숨기기  
        ...
        self.tbl_box4.horizontalHeader().setVisible(False)  # 가로 헤더 숨기기
        self.tbl_box4.verticalHeader().setVisible(False)    # 세로 헤더 숨기기  
        ...
        # 각 위젯(=아이템)의 index는 추가된 순서대로 0,1,2,3
        main_layout.setStretch(0, 1)  # box1 비중: 1
        main_layout.setStretch(1, 1)  # box2 비중: 2
        main_layout.setStretch(2, 2)  # box3 비중: 3
        main_layout.setStretch(3, 5)  # box4 비중: 1
